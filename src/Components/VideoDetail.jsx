...
function VideoDetail() 
{
  ...
  if (!videoDetail?.snippet) return <img src="https://loading.io/icon/tcjp3h" alt="" />
  if (!videos?.length) return <img src="https://loading.io/icon/tcjp3h" alt="" />
      ...
      <Stack direction={{ xs: 'column', md: 'row'}}>
        <Box flex={1}>
          ...
          <Stack direction='row' justifyContent='space-between' sx={{color: '#fff'}} py={1} px={2}>
            <Link to={`/channel/${channelId}`} style={{fontFamily: 'Roboto'}}>
